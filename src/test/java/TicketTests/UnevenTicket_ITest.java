...
public class UnevenTicket_ITest {
    ...
    public void Initialize(){
        ...
        Ticket t3 = f.getTicket(p3, 500, TicketTypes.RestaurantTicket, "rest3");
        t3.addPayer(p1,200);
        t3.addPayer(p2);
        t3.addPayer(p4);
    ...
    public void t_DivideBill(){
        ...
        assertThat("testing amount debt",-200 == controller.getTicket("Bob","rest3").getAmount(p1));
        assertThat("testing amount debt",-150 ==controller.getTicket("Bob","rest3").getAmount(p2));
        assertThat("testing amount debt",500 == controller.getTicket("Bob","rest3").getAmount(p3));
        assertThat("testing amount debt",-150 == controller.getTicket("Bob","rest3").getAmount(p4));
    }
}
